...
public class BasePage {
    ...
    public BasePage headerButtonClick (int numButton) {
        By headerButton = By.xpath("(//li[contains(@id,'menu-item')])[" + numButton + "]");
        driver.findElement(headerButton).click();
        return this;
    }

    public BasePage headerOpenClick () {
        By checkHeader = By.xpath("//li[@id='menu-item-941']");
    ...
    public BasePage footerButtonClick (int numButton) {
        By footerButton = By.xpath("(//div[@class='menu-footmenu-container']//li[contains(@class,'menu-item menu-item-type-post_type menu-item-object-page')])[" + numButton + "]");
